...
/**
 * @Auther: henjie
 * @Date: 2020/12/7 - 12 - 07 - 13:53
 * @Description: cn.mldn.service 定义emp表的业务层标准,此类一定要负责数据库的打开与关闭操作
...
public interface IEmpService {
     ...
     * 调用IEmpDAO.findAllsplit()方法，查询出所有的表数据，返回List<Emp>
